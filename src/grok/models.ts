export interface ModelInfo {
  ...
  transport?: "legacy_rest" | "ws_imagine" | "imagine_video";
  display_name: string;
  description: string;
...
export const MODEL_CONFIG: Record<string, ModelInfo> = {
  ...
  "grok-imagine-1.0-edit": {
    ...
    description: "Image edit model (multipart upload + conversation pipeline)",
  ...
  "grok-imagine-video": {
    ...
    rate_limit_model: "grok-3",
    transport: "imagine_video",
    display_name: "Grok Imagine Video",
    description: "Video generation model (imagine pipeline)",
