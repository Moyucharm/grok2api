...
async def create_image(
    ...
    await enforce_daily_quota(
        api_key, request.model or "grok-imagine-1.0", image_count=int(request.n or 1)
    )
...
async def edit_image(
    ...
    await enforce_daily_quota(
        api_key,
        edit_request.model or "grok-imagine-1.0-edit",
        image_count=int(edit_request.n or 1),
    )
